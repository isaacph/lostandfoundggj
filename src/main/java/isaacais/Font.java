...
public class Font {
    ...
    public Font(String source, int size, int bmpWidth, int bmpHeight) {
        ...
        glBindAttribLocation(shader, Shader.Attribute.POSITION.num, "position");
        glBindAttribLocation(shader, Shader.Attribute.TEXTURE.num, "tex");
...
//                vertices.flip();
                ...
                glVertexAttribPointer(Shader.Attribute.POSITION.num,
                    2, GL_FLOAT, false, 4 * 4, 0);
                glEnableVertexAttribArray(Shader.Attribute.TEXTURE.num);
                glVertexAttribPointer(Shader.Attribute.TEXTURE.num,
